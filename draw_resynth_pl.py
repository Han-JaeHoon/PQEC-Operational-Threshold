"""Draw the PennyLane implementation of the Step-4a 14-CNOT gadget (pqec_resynth_noise)."""
import matplotlib
matplotlib.use("Agg")
...
ax.set_title(
    f"Step 4a gadget, PennyLane implementation (pqec_resynth_noise.py) — {N_CX} CNOTs\n"
